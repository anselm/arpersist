...
let goodwords = [
 "#love", "Blimey", "Bad!", "Chill", "Buttery", "Luck", "gracious", 
 "golly", "rocket", "space", "peace", "tranquility", "hobgoblin", 
 "sad", "double plus not good", "button", "brick", "oatmeal", "bleep", 
 "bloop", "blarp", "censored"
];
